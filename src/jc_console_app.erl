...
%%% @doc Application module for the browser-based j_cache console. It assumes 
...
start(_StartType, _StartArgs) ->
    case application:get_env(jc, port, false) of
		...
		{'_', [
                       ...
                       {"/api/eventsource/map/:map", lasse_handler, 
                        [eventsource_handler]},
            ...
            lager:info("Admin service up and listening on port ~p.", [Port]),
