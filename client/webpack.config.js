...
const getEntry = function (env) {
  ...
  entry.push('cl-ui-common/lib/styles.css');
...
const getLoaders = function (env) {
  ...
  if (env === productionEnvironment ) {
    ...
    loaders.push({test: /(\.css|\.scss)$/, loaders: ['style-loader', 'css-loader?sourceMap', 'sass-loader?sourceMap']});
  }

  loaders.push({test: /\.jpe?g$|\.gif$|\.png$/i, loader:  "url-loader?limit=100000" });
  ...
  loaders.push({test: /\.woff2(\?\S*)?$/, loader: 'url-loader?limit=100000&mimetype=application/font-woff2' });
  loaders.push({test: /\.woff(\?\S*)?$/, loader: 'url-loader?limit=100000&mimetype=application/font-woff' });
...
function getConfig(env) {
  return {
    debug: true,
    devtool: env === productionEnvironment  ? 'source-map' : '#inline-source-map', // more info:https://webpack.github.io/docs/build-performance.html#sourcemaps and https://webpack.github.io/docs/configuration.html#devtool
