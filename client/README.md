...
| [Immutable](https://facebook.github.io/immutable-js/) | Provides many Persistent Immutable data structures including: List, Stack, Map, OrderedMap, Set, OrderedSet and Record. | [Introduction Video](https://egghead.io/lessons/javascript-immutable-js-introduction-easing-the-pains-of-mutability) |
...
| storybook | Runs the React Storybook server. |
...
### Explanation of the existing file structure. New file structure TBD!
```
.
...
│   ├── business              # Plain old JS objects (POJOs). Pure logic. No framework specific code here.
...
│   ├── mocha-init.js         # Required in once while running mocha tests
│   ├── srcServer.js          # Starts dev webserver with hot reloading and opens your app in your default browser
│   ├── test-common.js        # Should be imported by all test specs in order to have appropriate globals
